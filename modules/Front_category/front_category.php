		...
		<div class="container">
			<div class="row m-rl--1">
				<div class="col-12 p-rl-1 p-b-2">
					<div class="bg-img1 size-a-3 how1 pos-relative" style="background-image: url(<?=asset('test.jpg') ?>);">
				...
				<div class="col-sm-6 col-md-3 p-rl-1 p-b-2">
					<div class="bg-img1 size-a-14 how1 pos-relative" style="background-image: url(<?=asset('test.jpg') ?>);">
						<a href="blog-detail-01.html" class="dis-block how1-child1 trans-03"></a>
